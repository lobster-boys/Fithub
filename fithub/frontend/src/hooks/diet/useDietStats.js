...
export const useDietStats = () => {
  ...
  // 주간 통계 데이터 (임시 구현 - 실제로는 백엔드에서 가져와야 함)
  const weeklyStats = useMemo(() => {
    return {
      averageCalories: todayStats.totalCalories, // 임시
      averageProtein: todayStats.totalProtein,
      averageCarbs: todayStats.totalCarbs,
      averageFat: todayStats.totalFat,
      completionRate: todayStats.mealCompletion,
      daysTracked: 1 // 임시
    };
  }, [todayStats]);
